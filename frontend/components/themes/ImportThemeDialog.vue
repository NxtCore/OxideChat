...
async function handleImport() {
	...
	try {
		...
		error.value = e.message || mainStore.getTranslation('error_messages.theme_import_failed');
		...
		<DialogContent class="sm:max-w-md">
			<DialogHeader>
				...
				<DialogDescription>
					...
					<a href="https://tweakcn.com" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1 text-primary hover:underline ml-1">
						tweakcn.com
			...
			<div class="space-y-4 py-4">
				<div class="space-y-2">
					...
					<Input id="theme-url" v-model="themeUrl" placeholder="https://tweakcn.com/themes/themeId" :disabled="isLoading" @keyup.enter="handleImport" />
				</div>
